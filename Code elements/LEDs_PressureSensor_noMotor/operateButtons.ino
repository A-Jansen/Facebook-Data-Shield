...
void turnCoreOnAgain(int b1, int b2) {
  // Serial.println(b1);
  //Serial.println(b2);
  coreButtons[b1].turnComplexOn(leds_CORE);  //reuse complex function but this time for core!
  coreButtons[b2].turnComplexOn(leds_CORE);
  Serial.println(coreButtons[b1].checkState());
  Serial.println(coreButtons[b2].checkState());
}
